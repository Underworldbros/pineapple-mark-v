...
# Check symlinks (standard infusions - this is the definitive source of truth)
...
# Also check for dependency binaries in /sd/usr/sbin or /sd/usr/bin
$dep_bins = array('mdk3', 'aireplay', 'nbtscan', 'p0f', 'reaver', 'bully', 'pixiewps', 'nmap');
foreach ($dep_bins as $bin) {
    if (file_exists('/sd/usr/sbin/' . $bin) || file_exists('/sd/usr/bin/' . $bin)) {
        $installed[] = $bin;
    }
}
...
<div style="margin:4px 0;font-size:12px;"><span id="st-nmap" class="status-<?php echo getInfusionStatus('nmap', $installed); ?>" style="color:#888">&#9675;</span> nmap <button <?php echo getInfusionStatus('nmap', $installed) == 'installed' ? 'class="btn-uninstall" onclick="uninstall(\'nmap\')"' : 'onclick="install(\'nmap\')"'; ?> style="cursor:pointer;"><?php echo getInfusionStatus('nmap', $installed) == 'installed' ? 'Uninstall' : 'Install'; ?></button></div>
<div style="font-size:10px;color:#888;margin-top:5px;">Network scanner</div>
...
<div style="font-size:10px;color:#888;margin-top:5px;">NetBIOS scanner</div>
...
<div style="font-size:10px;color:#888;margin-top:5px;">Passive OS fingerprinting</div>
<div style="margin:4px 0;font-size:12px;"><span id="st-reaver" class="status-<?php echo getInfusionStatus('reaver', $installed); ?>" style="color:#888">&#9675;</span> reaver <button <?php echo getInfusionStatus('reaver', $installed) == 'installed' ? 'class="btn-uninstall" onclick="uninstall(\'reaver\')"' : 'onclick="install(\'reaver\')"'; ?> style="cursor:pointer;"><?php echo getInfusionStatus('reaver', $installed) == 'installed' ? 'Uninstall' : 'Install'; ?></button></div>
<div style="font-size:10px;color:#888;margin-top:5px;">WPS brute force (includes wash)</div>
<div style="margin:4px 0;font-size:12px;"><span id="st-bully" class="status-<?php echo getInfusionStatus('bully', $installed); ?>" style="color:#888">&#9675;</span> bully <button <?php echo getInfusionStatus('bully', $installed) == 'installed' ? 'class="btn-uninstall" onclick="uninstall(\'bully\')"' : 'onclick="install(\'bully\')"'; ?> style="cursor:pointer;"><?php echo getInfusionStatus('bully', $installed) == 'installed' ? 'Uninstall' : 'Install'; ?></button></div>
<div style="font-size:10px;color:#888;margin-top:5px;">WPS brute force (alternate)</div>
<div style="margin:4px 0;font-size:12px;"><span id="st-pixiewps" class="status-<?php echo getInfusionStatus('pixiewps', $installed); ?>" style="color:#888">&#9675;</span> pixiewps <button <?php echo getInfusionStatus('pixiewps', $installed) == 'installed' ? 'class="btn-uninstall" onclick="uninstall(\'pixiewps\')"' : 'onclick="install(\'pixiewps\')"'; ?> style="cursor:pointer;"><?php echo getInfusionStatus('pixiewps', $installed) == 'installed' ? 'Uninstall' : 'Install'; ?></button></div>
<div style="font-size:10px;color:#888;margin-top:5px;">Pixie Dust attack</div>
</div>
